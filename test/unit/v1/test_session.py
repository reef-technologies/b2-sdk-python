...
class TestB2Session(TestBase):
    ...
    def test_establish_sse_c_replace(self):
        ...
        self.assertEqual(
            (MetadataDirectiveMode.REPLACE, file_info, content_type),
    ...
    def test_establish_sse_c_copy_no_enc(self):
        ...
        self.assertEqual(
            (MetadataDirectiveMode.COPY, file_info, content_type),
            (metadata_directive, new_file_info, new_content_type)
        )
        ...
        with mock.patch.object(self.session, 'get_file_info_by_id') as get_file_info:
            get_file_info.side_effect = lambda *a, **kw: {
                "accountId":
                    "4aa9865d6f00",
                "bucketId":
                    "547a2a395826655d561f0010",
                "contentLength":
                    1350,
                "contentSha1":
                    "753ca1c2d0f3e8748320b38f5da057767029a036",
                "contentType":
                    "application/octet-stream",
                "fileId":
                    "4_z547a2a395826655d561f0010_f106d4ca95f8b5b78_d20160104_m003906_c001_v0001013_t0005",
                "fileInfo": {
                    'sse_c_key_id': 'some-other-id',
                    'pre-existing': 'value'
                },
                "fileName":
                    "name",
