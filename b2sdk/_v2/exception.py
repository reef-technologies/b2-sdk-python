...
__all__ = (
    'AccountInfoError', 'AlreadyFailed', 'B2ConnectionError', 'B2Error', 'B2HttpCallbackException',
    'B2HttpCallbackPostRequestException', 'B2HttpCallbackPreRequestException', 'B2RequestTimeout',
    'B2RequestTimeoutDuringUpload', 'B2SimpleError', 'BadDateFormat', 'BadFileInfo', 'BadJson',
    'BadUploadUrl', 'BrokenPipe', 'BucketNotAllowed', 'CapabilityNotAllowed', 'CapExceeded',
    'ChecksumMismatch', 'ClockSkew', 'CommandError', 'Conflict', 'ConnectionReset',
    'CorruptAccountInfo', 'DestFileNewer', 'DuplicateBucketName', 'EnvironmentEncodingError',
    'FileAlreadyHidden', 'FileNameNotAllowed', 'FileNotPresent', 'FileSha1Mismatch',
    'IncompleteSync', 'InvalidArgument', 'InvalidAuthToken', 'InvalidMetadataDirective',
    'InvalidRange', 'InvalidUploadSource', 'MaxFileSizeExceeded', 'MaxRetriesExceeded',
    'MissingAccountData', 'MissingPart', 'NonExistentBucket', 'NotAllowedByAppKeyError',
    'PartSha1Mismatch', 'RestrictedBucket', 'ServiceError', 'StorageCapExceeded', 'TooManyRequests',
