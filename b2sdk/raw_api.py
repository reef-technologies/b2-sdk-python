...
class AbstractRawApi(metaclass=ABCMeta):
    ...
    @abstractmethod
    def get_file_info_by_id(self, api_url: str, account_auth_token: str, file_id: str) -> Dict[str, Any]:
        pass
    ...
    @abstractmethod
    def list_keys(self, api_url, account_auth_token, account_id, max_key_count=None, start_application_key_id=None):
        pass
...
class B2RawHTTPApi(AbstractRawApi):
    ...
    def create_bucket(
        ...
        kwargs = dict(accountId=account_id, bucketName=bucket_name, bucketType=bucket_type)
        ...
        if default_server_side_encryption is not None:
            ...
            kwargs['defaultServerSideEncryption'] = default_server_side_encryption.serialize_to_json_for_request()
        ...
        return self._post_json(api_url, 'b2_create_bucket', account_auth_token, **kwargs)
    ...
    def delete_bucket(self, api_url, account_auth_token, account_id, bucket_id):
        return self._post_json(
            api_url, 'b2_delete_bucket', account_auth_token, accountId=account_id, bucketId=bucket_id
        )

    def delete_file_version(self, api_url, account_auth_token, file_id, file_name):
        return self._post_json(
            api_url, 'b2_delete_file_version', account_auth_token, fileId=file_id, fileName=file_name
        )
    ...
    def update_bucket(
        ...
        return self._post_json(
            api_url, 'b2_update_bucket', account_auth_token, accountId=account_id, bucketId=bucket_id, **kwargs
        )
    ...
    def update_file_legal_hold(self, api_url, account_auth_token, file_id, file_name, legal_hold: LegalHold):
        try:
            return self._post_json(
                api_url,
    ...
    def copy_file(
        ...
        if source_server_side_encryption is not None:
            ...
            kwargs['sourceServerSideEncryption'] = source_server_side_encryption.serialize_to_json_for_request()
