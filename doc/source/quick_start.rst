...
.. code-block:: python
    ...
    >>> print('File name:   ', downloaded_file.file_version.file_name)
    File name:    som2.pdf
    >>> print('File id:     ', downloaded_file.file_version.id_)
    File id:      4_z5485a1682662eb3e60980d10_f1195145f42952533_d20190403_m130258_c002_v0001111_t0002
    >>> print('File size:   ', downloaded_file.file_version.size)
    File size:    1870579
    >>> print('Content type:', downloaded_file.file_version.content_type)
    Content type: application/pdf
    >>> print('Content sha1:', downloaded_file.file_version.content_sha1)
