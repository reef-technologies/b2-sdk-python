######################################################################
#
# File: test/unit/v0/test_version_utils.py
#
...
class TestRenameArgument(TestBase):
    ...
    def test_outdated_replacement(self):
        with self.assertRaises(
            AssertionError,
            msg="rename_argument decorator is still used in version %s when old argument name 'aaa' was scheduled to be dropped in 0.1.2. It is time to remove the mapping."
            % (self.VERSION,),
        ):
