...
class AbstractDownloadDestination(metaclass=B2TraceMetaAbstract):
    ...
    def make_file_context(
        self, file_id, file_name, content_length, content_type, content_sha1, file_info, mod_time_millis, range_=None
    ):
        """
...
class DownloadDestProgressWrapper(AbstractDownloadDestination):
    ...
    def write_file_and_report_progress_context(
        self, file_id, file_name, content_length, content_type, content_sha1, file_info, mod_time_millis, range_
    ):
