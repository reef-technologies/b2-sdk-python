...
from .file_version import B2FileVersion, B2FileVersionFactory
...
class Bucket(metaclass=B2TraceMeta):
    ...
    def get_file_info_by_id(self, file_id: str) -> B2FileVersion:
        """
        ...
        """
        return B2FileVersionFactory.from_api_response(self.api.get_file_info(file_id))

    def get_file_info_by_name(self, file_name: str) -> B2FileVersion:
        """
        ...
        """
        try:
            return B2FileVersionFactory.from_response_headers(
    ...
    def list_file_versions(self, file_name, fetch_count=None):
        ...
        while 1:
            ...
            for entry in response['files']:
                file_version = B2FileVersionFactory.from_api_response(entry)
    ...
    def hide_file(self, file_name):
        ...
        return B2FileVersionFactory.from_api_response(response)
